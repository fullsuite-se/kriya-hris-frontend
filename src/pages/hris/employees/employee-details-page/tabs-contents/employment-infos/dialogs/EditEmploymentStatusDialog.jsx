...
const EditEmploymentStatusDialog = ({ trigger }) => {
  ...
  const onSaveChanges = async (data) => {
    ...
    try {
      ...
      if (
        ...
        glassToast({
          message: `No changes in Employment Status.`,
      ...
      glassToast({
        message: (
          <>
            <span style={{ color: "#008080" }}>Employment Status</span> updated
            successfully!
          </>
        ),
...
export default EditEmploymentStatusDialog;
