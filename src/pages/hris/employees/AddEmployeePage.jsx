...
const AddEmployeePage = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    const payload = {
      ...
      date_hired: toYMDLocal(formData?.dateHired),
      date_regularization: toYMDLocal(formData?.dateRegularized),
      date_offboarding: toYMDLocal(formData?.dateOffboarded),
      date_separated: toYMDLocal(formData?.dateSeparated),
